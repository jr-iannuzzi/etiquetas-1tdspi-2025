        ...
        <div className="font-sans bg-blue-500 min-h-screen p-5 flex gap-5">
            <form onSubmit={handleSubmit(onSubmit)} className="w-96 m-auto bg-white rounded-md p-1 flex flex-col gap-5">
                <fieldset className="p-5 mb-5">
                    ...
                    <input className="mb-1 p-1.5 rounded-md outline-gray-400 w-full border-gray-200" placeholder="Nome" {...register('nome',{required:'Nome obrigatório!'})} />
                    {errors.nome && <span className="text-red-500 mb-1">{errors.nome.message as string}</span>}
                    <input className="mb-1 p-1.5 rounded-md outline-gray-400 w-full border-gray-200" placeholder="E-mail" {...register('email', {
                    ...
                    <input className="mb-1 p-1.5 rounded-md outline-gray-400 w-full border-gray-200" placeholder="CPF" {...registerWithMask('cpf', '999.999.999-99')} />
                    {errors.cpf && <span className="text-red-500 mb-1">{errors.cpf.message as string}</span>}
                </fieldset>
                <fieldset>
                    <legend>Endereço</legend>
                    <input className="mb-1 p-1.5 rounded-md outline-gray-400 w-full border-2 border-gray-200" placeholder="CEP" {...registerWithMask('cep', '99999-99')}
                    onBlur={searchCEP} />
            ...
            <div className="mt-4 w-full bg-gray-400 flex flex-wrap justify-evenly grow">
                
                {
                    ...
                    <div key={index} className="h-68 p-2.5 border-2 border-blue-900 w-96 m-2.5 bg-blue-500 rounded-md">
                        ...
                        <p className="mb-1 font-bold">n°: {cli.numero}</p>
